...
const DashHeader: React.FC = () => {
    return (
        <div>
            <div className="navbar shadow-3xl bg-base-300">
                <div className="flex-1">
                    <Link to="/dashboard">
                       <span className="btn btn-ghost normal-case text-xl">
                        <svg className="fill-primary w-[100px] md:w-[130px] lg:w-[190px]"
                             xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 143 22"><g><path
                            d="M100.561,6.134c-2.758,0-5.003,2.244-5.003,5.002v2.022c0,2.758,2.245,5.002,5.003,5.002 c1.457,0,2.766-0.63,3.681-1.627v1.627h1.321v-5.002v-0.661v-1.361C105.563,8.378,103.318,6.134,100.561,6.134 M104.241,12.498 v0.661c0,2.028-1.651,3.681-3.681,3.681c-2.03,0-3.682-1.652-3.682-3.681v-2.022c0-2.03,1.651-3.682,3.682-3.682 c2.029,0,3.681,1.652,3.681,3.682V12.498z"></path><path
                            d="M87.857,6.134c-1.457,0-2.766,0.63-3.682,1.627V3.422h-1.321v7.714v2.769v4.257h1.321v-4.257v-2.769 c0-2.029,1.651-3.681,3.682-3.681c2.029,0,3.682,1.652,3.682,3.681v7.025h1.32v-7.025C92.859,8.378,90.615,6.134,87.857,6.134"></path><path
                            d="M113.445,6.134c-1.457,0-2.766,0.63-3.681,1.627V6.134h-1.321v5.002v0.661v6.364h1.321v-6.364v-0.661 c0-2.029,1.651-3.681,3.681-3.681c2.03,0,3.682,1.652,3.682,3.681v7.025h1.32v-7.025C118.447,8.378,116.203,6.134,113.445,6.134"></path><path
                            d="M74.641,6.134c-1.457,0-2.766,0.63-3.682,1.627V6.134h-1.321v5.002v0.661v6.364h1.321v-6.364v-0.661 c0-2.029,1.652-3.681,3.682-3.681c2.03,0,3.682,1.652,3.682,3.681v7.025h1.32v-7.025C79.643,8.378,77.398,6.134,74.641,6.134"></path><path
                            d="M126.148,16.84c-2.029,0-3.681-1.652-3.681-3.681v-2.022c0-2.03,1.651-3.682,3.681-3.682 c1.561,0,2.955,0.988,3.473,2.458l1.248-0.439c-0.705-1.998-2.602-3.34-4.721-3.34c-2.758,0-5.002,2.244-5.002,5.003v2.022 c0,2.758,2.244,5.002,5.002,5.002c2.122,0,4.02-1.345,4.721-3.345l-1.246-0.438C129.106,15.852,127.711,16.84,126.148,16.84"></path><path
                            d="M141.645,6.134v5.017c0,0.988-0.387,1.916-1.094,2.617l-2.588,2.588l-2.59-2.59 c-0.703-0.697-1.092-1.627-1.092-2.615V6.134h-1.32v5.017c0,1.344,0.526,2.605,1.48,3.551l3.521,3.521l3.52-3.52 c0.957-0.948,1.482-2.209,1.482-3.553V6.134H141.645z"></path><polygon
                            points="58.256,11.294 66.356,11.294 66.356,9.973 58.256,9.973 58.256,4.743 66.746,4.743 66.746,3.422 56.936,3.422 56.936,9.973 56.936,11.294 56.936,18.16 66.94,18.16 66.94,16.84 58.256,16.84 "></polygon><path
                ...
                <div className="flex-none">
                    <div className="dropdown dropdown-end ">
                        ...
                        <ul tabIndex={1}
                            className="dropdown-content menu p-2 shadow rounded-box w-52 bg-base-300 ">
                            <li>
                                <Link className="w-[100%] justify-between text-primary" to="/me">
                                    <span className="justify-between text-primary">Profile<span
                                        className="badge">New</span></span>
                                </Link>
                            </li>

                            <li><Link to="/me/edit"><span>Settings</span></Link></li>
                            <li><Link to="/me/logout"><span>Logout</span></Link></li>
                        </ul>
                    </div>
                    <Link to="/">
