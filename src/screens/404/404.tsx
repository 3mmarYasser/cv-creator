...
const Page404: React.FC = () => {
    return (
        <div className="w-screen h-screen flex justify-center items-center text-6xl bg-base-300 flex-col">
           <b className="whitespace-nowrap uppercase animate-bounce flex flex-col items-center justify-center "><h1 className="text-8xl ">4<span className="text-primary">0</span>4</h1>
